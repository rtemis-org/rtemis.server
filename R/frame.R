...
#
# See specs/rtemislive.md §3.3 and §4 for the full wire format and envelope
...
#' @param code Character. One of the error codes in spec §15.
...
#'
#' @param event Character. Event name (see spec §8 for the catalog).
