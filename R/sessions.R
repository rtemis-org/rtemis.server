...
# Session registry and lifecycle for rtemislive. See specs/rtemislive.md §5.
#
# Storage model
# -------------
...
#' @param ttl Numeric, seconds. Default 86400 (24 h, spec §5.7).
#'
